'''
1D Gaussian Process regression on synthetic sine data: compares numerical (Metropolis sampling) and analytical posteriors
'''
...
for num in range(51): # adjust this value to change how many iterations run
    pre = []
